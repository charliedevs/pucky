...
export class PlayerDebugOverlay extends Container {
  ...
  public updateOverlay() {
    ...
    const props: any[] = [
      p['facingDir'],
      p['jumpState']['isSquashing'],
      p['jumpState']['lastFallSpeed'].toFixed(2),
      p['jumpState']['playedLandingSquash'],
      p['isSkidding'],
      p['jumpState']['timeSinceGrounded'].toFixed(0),
      p['jumpState']['buffer'].toFixed(0),
      p['jumpHeld'],
      a.vel.x.toFixed(2),
      a.vel.y.toFixed(2),
      a.isOnGround,
